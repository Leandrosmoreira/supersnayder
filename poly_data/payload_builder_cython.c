...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "poly_data.payload_builder_cython",
        "sources": [
            "poly_data/payload_builder_cython.pyx"
        ]
    },
    "module_name": "poly_data.payload_builder_cython"
}
END: Cython Metadata */
...
#define __PYX_HAVE__poly_data__payload_builder_cython
#define __PYX_HAVE_API__poly_data__payload_builder_cython
/* Early includes */
#include <string.h>
#ifdef _OPENMP
#include <omp.h>
...
/* Module declarations from "poly_data.payload_builder_cython" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "poly_data.payload_builder_cython"
extern int __pyx_module_is_main_poly_data__payload_builder_cython;
int __pyx_module_is_main_poly_data__payload_builder_cython = 0;

/* Implementation of "poly_data.payload_builder_cython" */
/* #### Code section: global_var ### */
/* #### Code section: string_decls ### */
static const char __pyx_k_FASE_8_Cython_payload_builder_p[] = "\nFASE 8: Cython payload builder para cria\303\247\303\243o eficiente de JSON.\n";
/* #### Code section: decls ### */
static PyObject *__pyx_pf_9poly_data_22payload_builder_cython_build_order_payload_fast(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_market_id, PyObject *__pyx_v_action, double __pyx_v_price, double __pyx_v_size, int __pyx_v_price_scale); /* proto */
...
#define __pyx_kp_u_poly_data_payload_builder_cython_2 __pyx_string_tab[3]
#define __pyx_n_u_Pyx_PyDict_NextRef __pyx_string_tab[4]
#define __pyx_n_u_action __pyx_string_tab[5]
#define __pyx_n_u_asyncio_coroutines __pyx_string_tab[6]
#define __pyx_n_u_build_order_payload_fast __pyx_string_tab[7]
...
#define __pyx_n_u_market_id __pyx_string_tab[13]
#define __pyx_n_u_module __pyx_string_tab[14]
#define __pyx_n_u_name __pyx_string_tab[15]
#define __pyx_n_u_payload __pyx_string_tab[16]
#define __pyx_n_u_poly_data_payload_builder_cython __pyx_string_tab[17]
#define __pyx_n_u_pop __pyx_string_tab[18]
#define __pyx_n_u_price __pyx_string_tab[19]
#define __pyx_n_u_price_int __pyx_string_tab[20]
#define __pyx_n_u_price_scale __pyx_string_tab[21]
...
#define __pyx_n_u_side __pyx_string_tab[25]
#define __pyx_n_u_size __pyx_string_tab[26]
#define __pyx_n_u_size_int __pyx_string_tab[27]
#define __pyx_n_u_test __pyx_string_tab[28]
#define __pyx_n_u_token_id __pyx_string_tab[29]
#define __pyx_n_u_values __pyx_string_tab[30]
#define __pyx_kp_b_iso88591_ST_vRq_a_A_1 __pyx_string_tab[31]
...
/* "poly_data/payload_builder_cython.pyx":12
...
/* Python wrapper */
static PyObject *__pyx_pw_9poly_data_22payload_builder_cython_1build_order_payload_fast(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
...
PyDoc_STRVAR(__pyx_doc_9poly_data_22payload_builder_cython_build_order_payload_fast, "Constr\303\263i payload de ordem de forma otimizada (Cython).\n    \n    Args:\n        market_id: ID do mercado\n        action: 'BUY' ou 'SELL'\n        price: Pre\303\247o (float)\n        size: Tamanho (float)\n        price_scale: Escala para convers\303\243o (default 1000 = mils)\n    \n    Returns:\n        dict pronto para serializa\303\247\303\243o JSON\n    ");
static PyMethodDef __pyx_mdef_9poly_data_22payload_builder_cython_1build_order_payload_fast = {"build_order_payload_fast", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_9poly_data_22payload_builder_cython_1build_order_payload_fast, __Pyx_METH_FASTCALL|METH_KEYWORDS, __pyx_doc_9poly_data_22payload_builder_cython_build_order_payload_fast};
static PyObject *__pyx_pw_9poly_data_22payload_builder_cython_1build_order_payload_fast(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __Pyx_RefNannySetupContext("build_order_payload_fast (wrapper)", 0);
  #if !CYTHON_METH_FASTCALL
  #if CYTHON_ASSUME_SAFE_SIZE
  ...
  {
    PyObject ** const __pyx_pyargnames[] = {&__pyx_mstate_global->__pyx_n_u_market_id,&__pyx_mstate_global->__pyx_n_u_action,&__pyx_mstate_global->__pyx_n_u_price,&__pyx_mstate_global->__pyx_n_u_size,&__pyx_mstate_global->__pyx_n_u_price_scale,0};
    ...
    if (__pyx_kwds_len > 0) {
      ...
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "build_order_payload_fast", 0) < (0)) __PYX_ERR(0, 12, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 4; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("build_order_payload_fast", 0, 4, 5, i); __PYX_ERR(0, 12, __pyx_L3_error) }
      }
    } else {
      switch (__pyx_nargs) {
        case  5:
    ...
    __pyx_v_market_id = ((PyObject*)values[0]);
    __pyx_v_action = ((PyObject*)values[1]);
    __pyx_v_price = __Pyx_PyFloat_AsDouble(values[2]); if (unlikely((__pyx_v_price == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 14, __pyx_L3_error)
    __pyx_v_size = __Pyx_PyFloat_AsDouble(values[3]); if (unlikely((__pyx_v_size == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 14, __pyx_L3_error)
    if (values[4]) {
      __pyx_v_price_scale = __Pyx_PyLong_As_int(values[4]); if (unlikely((__pyx_v_price_scale == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 14, __pyx_L3_error)
    } else {
      __pyx_v_price_scale = ((int)((int)0x3E8));
    }
  }
  goto __pyx_L6_skip;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("build_order_payload_fast", 0, 4, 5, __pyx_nargs); __PYX_ERR(0, 12, __pyx_L3_error)
  __pyx_L6_skip:;
  ...
  __Pyx_AddTraceback("poly_data.payload_builder_cython.build_order_payload_fast", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_market_id), (&PyUnicode_Type), 1, "market_id", 1))) __PYX_ERR(0, 14, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_action), (&PyUnicode_Type), 1, "action", 1))) __PYX_ERR(0, 14, __pyx_L1_error)
  __pyx_r = __pyx_pf_9poly_data_22payload_builder_cython_build_order_payload_fast(__pyx_self, __pyx_v_market_id, __pyx_v_action, __pyx_v_price, __pyx_v_size, __pyx_v_price_scale);
...
static PyObject *__pyx_pf_9poly_data_22payload_builder_cython_build_order_payload_fast(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_market_id, PyObject *__pyx_v_action, double __pyx_v_price, double __pyx_v_size, int __pyx_v_price_scale) {
  int __pyx_v_price_int;
  int __pyx_v_size_int;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("build_order_payload_fast", 0);

  /* "poly_data/payload_builder_cython.pyx":28
 *     """
 *     # Converter preo para int (fixed-point)
 *     cdef int price_int = <int>(price * price_scale)             # <<<<<<<<<<<<<<
 *     cdef int size_int = <int>(size)
 * 
*/
  __pyx_v_price_int = ((int)(__pyx_v_price * __pyx_v_price_scale));

  /* "poly_data/payload_builder_cython.pyx":29
 *     # Converter preo para int (fixed-point)
 *     cdef int price_int = <int>(price * price_scale)
 *     cdef int size_int = <int>(size)             # <<<<<<<<<<<<<<
 * 
 *     # Construir payload
*/
  __pyx_v_size_int = ((int)__pyx_v_size);

  /* "poly_data/payload_builder_cython.pyx":33
 *     # Construir payload
 *     cdef dict payload = {
 *         'token_id': market_id,             # <<<<<<<<<<<<<<
 *         'price': price_int,
...
*/
  ...
  if (PyDict_SetItem(__pyx_t_1, __pyx_mstate_global->__pyx_n_u_token_id, __pyx_v_market_id) < (0)) __PYX_ERR(0, 33, __pyx_L1_error)

  /* "poly_data/payload_builder_cython.pyx":34
 *     cdef dict payload = {
 *         'token_id': market_id,
 *         'price': price_int,             # <<<<<<<<<<<<<<
 *         'size': size_int,
 *         'side': action
*/
  __pyx_t_2 = __Pyx_PyLong_From_int(__pyx_v_price_int); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 34, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_t_1, __pyx_mstate_global->__pyx_n_u_price, __pyx_t_2) < (0)) __PYX_ERR(0, 33, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "poly_data/payload_builder_cython.pyx":35
 *         'token_id': market_id,
 *         'price': price_int,
 *         'size': size_int,             # <<<<<<<<<<<<<<
 *         'side': action
 *     }
*/
  __pyx_t_2 = __Pyx_PyLong_From_int(__pyx_v_size_int); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 35, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_t_1, __pyx_mstate_global->__pyx_n_u_size, __pyx_t_2) < (0)) __PYX_ERR(0, 33, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "poly_data/payload_builder_cython.pyx":36
 *         'price': price_int,
 *         'size': size_int,
 *         'side': action             # <<<<<<<<<<<<<<
 *     }
 * 
*/
  if (PyDict_SetItem(__pyx_t_1, __pyx_mstate_global->__pyx_n_u_side, __pyx_v_action) < (0)) __PYX_ERR(0, 33, __pyx_L1_error)
  __pyx_v_payload = ((PyObject*)__pyx_t_1);
  __pyx_t_1 = 0;

  /* "poly_data/payload_builder_cython.pyx":39
 *     }
 * 
 *     return payload             # <<<<<<<<<<<<<<
 * 
...
static int __pyx_pymod_exec_payload_builder_cython(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_payload_builder_cython},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
namespace {
  ...
  #endif
  {
      ...
      "payload_builder_cython",
      __pyx_k_FASE_8_Cython_payload_builder_p, /* m_doc */
    #if CYTHON_USE_MODULE_STATE
...
__Pyx_PyMODINIT_FUNC PyInit_payload_builder_cython(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_payload_builder_cython(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_payload_builder_cython(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'payload_builder_cython' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "payload_builder_cython" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_payload_builder_cython", 0);
  ...
  if (__pyx_module_is_main_poly_data__payload_builder_cython) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "poly_data.payload_builder_cython")) {
      if (unlikely((PyDict_SetItemString(modules, "poly_data.payload_builder_cython", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
  ...
  /* "poly_data/payload_builder_cython.pyx":14
 * @cython.boundscheck(False)
 * @cython.wraparound(False)
 * def build_order_payload_fast(str market_id, str action, double price, double size, int price_scale=1000):             # <<<<<<<<<<<<<<
 *     """Constri payload de ordem de forma otimizada (Cython).
 * 
*/
  __pyx_t_2 = __Pyx_PyLong_From_int(((int)0x3E8)); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 14, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
...
*/
  ...
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_9poly_data_22payload_builder_cython_1build_order_payload_fast, 0, __pyx_mstate_global->__pyx_n_u_build_order_payload_fast, NULL, __pyx_mstate_global->__pyx_n_u_poly_data_payload_builder_cython, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[0])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 12, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  ...
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_build_order_payload_fast, __pyx_t_2) < (0)) __PYX_ERR(0, 12, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "poly_data/payload_builder_cython.pyx":1
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init poly_data.payload_builder_cython", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init poly_data.payload_builder_cython");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 8; } index[] = {{1},{179},{8},{36},{20},{6},{18},{24},{18},{8},{13},{5},{8},{9},{10},{8},{7},{32},{3},{5},{9},{11},{12},{12},{10},{4},{4},{8},{8},{8},{6},{57}};
    #if (CYTHON_COMPRESS_STRINGS) == 2 /* compression: bz2 (448 bytes) */
const char* const cstring = "BZh91AY&SY\233?\026k\000\000\"\377\363\347DeT@\203\244@\257!\\\000\277\377\377p@@@@@\000\000@@\000@\0000\001f\220CPjmD\331\002d\365'\250hh\017Q\240\r43C\321C\230\000&L\000&\023\004\302\030\0020\000\324\304\310\2324\021\240M4\321\220\000\000\000\323@\203\264\215\367\246\014F\"\022\220\tj\030\222i3V\335\226\354\321\355\267\234\267,\376\013\201\013\332\325\251\214\311\257O\251\234\2771\246\027w\325u\255\251\312\032<}\026\261^\030\353 X)\tH\254~\336\267\346\265\235\020a\371\305\301 \260\203\220\004xd\017'(P\377}\334\356\322[+\323\351\373K\276\262k\216\020\0163\312(\246#\002\352\347\034_\230P\345\220\356J\324\360\323{\004Y\001\003Q\022'\245\201q\312B\203\\O]Gd\362V\022\231\261\316\207aLP\251Q)\241\334\312\221$\213&\031\344\232\266F\240\206\333\366\333\224\212\232\034\353\